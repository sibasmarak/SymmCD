...
#SBATCH --array=0
#SBATCH --output=mp_20_sweep_output/mp20-eval-laced-galaxy-208-experiment-%A.%a.out
...
python scripts/generation.py --model_path /home/mila/s/siba-smarak.panigrahi/scratch/DiffCSP/hydra/singlerun/2024-01-23/mp_20_actual_repr/laced-galaxy-208/ --dataset mp --label final_num_samples_20
python scripts/compute_metrics.py --root_path /home/mila/s/siba-smarak.panigrahi/scratch/DiffCSP/hydra/singlerun/2024-01-23/mp_20_actual_repr/laced-galaxy-208/ --tasks gen --gt_file data/mp_20/test.csv --label final_num_samples_20
