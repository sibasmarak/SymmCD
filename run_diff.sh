...
# training
# HYDRA_FULL_ERROR=1 python diffcsp/run.py expname=mp_20_transformer_gt_frac_coords data=mp_20 data.number_representatives=0 data.train_max_epochs=100000 \
# logging.wandb.mode=online logging.wandb.project=diffcsp_symmetry logging.val_check_interval=1 optim.optimizer.lr=0.001 \
# model=diffusion_w_site_symm model.use_ks=True model.ip=False model.use_gt_frac_coords=True model.use_site_symm=True model.decoder.network=transformer \
