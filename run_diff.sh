...
#SBATCH --array=0
#SBATCH --output=mp_20_sweep_output/mp20-eval-experiment-%A.%a.out
...
# python scripts/generation.py --model_path /home/mila/s/siba-smarak.panigrahi/scratch/DiffCSP/hydra/shared/mp_20_001/astral-sweep-42 --dataset mp --label final_num_samples_20 --batch_size 5
# python scripts/compute_metrics.py --root_path /home/mila/s/siba-smarak.panigrahi/scratch/DiffCSP/hydra/shared/mp_20_001/astral-sweep-42 --tasks gen --gt_file data/mp_20/test.csv --label final_num_samples_20
