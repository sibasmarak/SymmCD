...
class CSPDiffusion(BaseModule):
    ...
    def forward(self, batch):
        ...
        ks = batch.ks
        if self.use_ks:
            lattices = lattice_ks_to_matrix_torch(ks)
        else:
        ...
        pred_lattice, pred_x, pred_t = self.decoder(time_emb, atom_type_probs, input_frac_coords, lattice_feats, input_lattice, batch.num_atoms, batch.batch, batch.spacegroup)
